...
const Footer = () => {
    return (
        <div className="section bg-gray-800 text-white p-20 pb-0 mt-10">
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-10 mb-8">
                <div>
                    <div className="text-xl font-semibold mb-3">RinosZone</div>
                    <p className="text-[1rem] mb-3">
                        Sumérgete en la magia del cine y descubre los últimos estrenos en pantalla grande.
                        ¡Conéctate con nosotros en las redes sociales para estar al tanto de todas las
                        novedades y ofertas exclusivas! No te pierdas ni un solo detalle de la experiencia
                        cinematográfica.
                    </p>
            ...
            <div className="flex flex-wrap justify-between gap-4 pb-8">
                <div className="">
                    2024 Copyright &#169; <span className="font-bold">Grupo RinosZone</span>. All
                    rights deserved.
                </div>
